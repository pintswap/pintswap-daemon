...
class FlashbotsBundleProvider extends ethers_1.JsonRpcProvider {
    ...
    static getBaseFeeInNextBlock(currentBaseFeePerGas, currentGasUsed, currentGasLimit) {
        ...
        if (BigInt(currentGasUsed) === BigInt(currentGasTarget)) {
            ...
            const baseFeePerGasDelta = (BigInt(currentBaseFeePerGas) * BigInt(gasUsedDelta) / BigInt(currentGasTarget)) / BigInt(exports.BASE_FEE_MAX_CHANGE_DENOMINATOR);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const tx of bundledTransactions) {
                ...
                const nonce = transaction.nonce !== undefined
                    ? transaction.nonce
                    : nonces[address] || BigInt((yield this.genericProvider.getTransactionCount(address, 'latest')));
    ...
    simulate(signedBundledTransactions, blockTag, stateBlockTag, blockTimestamp, coinbase) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof blockTag === 'number') {
                ...
                const blockDetails = blockTagDetails !== null ? blockTagDetails : yield this.genericProvider.getBlock('latest');
            ...
            for (let currentBundleId = 0; currentBundleId < bundleCount; currentBundleId++) {
                ...
                const currentBundleSignedTxs = yield Promise.all(currentBundleTransactions.map((competitorBundleBlocksApiTx) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (tx.signature.v !== undefined && tx.signature.r !== undefined && tx.signature.s !== undefined) {
                        ...
                        const result = ethers_1.Transaction.from(Object.assign(Object.assign({}, tx), { signature: ethers_1.Signature.from({ v: tx.signature.v, r: tx.signature.r, s: tx.signature.s }) }));
                        return result;
                    }
