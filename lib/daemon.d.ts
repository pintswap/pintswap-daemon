...
export declare function sendBundle(mevshare: MevShareClient, txs: any, blockNumber: any): Promise<import("@flashbots/mev-share-client/build/api/interfaces").ISendBundleResult>;
