...
function waitForBlock(provider, number) {
    return __awaiter(this, void 0, void 0, function* () {
        while (true) {
            const block = yield provider.getBlock(number);
            if (block)
                return block;
        }
    });
...
function sendBundle(flashbots, txs, blockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!receipt)
            return yield sendBundle(flashbots, txs, blockNumber + 1);
        return receipt;
    });
}
