...
function sendBundle(logger, flashbots, txs, blockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const list = yield Promise.all(BUILDER_RPCS.map((rpc) => __awaiter(this, void 0, void 0, function* () {
            return (yield flashbots_1.FlashbotsBundleProvider.create(flashbots.provider, flashbots.authSigner, rpc)).sendBundle(txs, blockNumber)
                .catch((err) => {
                /* logger.error(err) */
            });
        })));
        ...
        logger.info(receipt);
        if (!receipt)
            return yield sendBundle(logger, flashbots, txs, blockNumber + 1);
        return receipt;
    });
}
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        exports.logger.info("using peerid: " + pintswap.address);
        ...
        rpc.post("/peer", (req, res) => {
            (() => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const peerObject = yield pintswap.getUserData(peer);
        ...
        rpc.post("/trade", (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (peer.indexOf(".") !== -1)
                    peer = yield pintswap.resolveName(peer);
                const { offers } = yield pintswap.getUserData(peer);
                trades = trades.map((v) => ({
                    amount: v.amount,
                ...
                if (broadcast) {
                    ...
                    const bundleResult = (yield sendBundle(pintswap.logger, flashbots, txs.map((v) => v.transaction), blockNumber + 1));
