...
function providerFromChainId(chainId) {
    switch (Number(chainId)) {
        ...
        case 324:
            return new ethers_1.ethers.JsonRpcProvider("https://mainnet.era.zksync.io");
    }
    throw Error("chainid " + chainId + " not supported");
}
exports.providerFromChainId = providerFromChainId;
const _formatTransactionReceipt = format.object({
...
format.formatTransactionReceipt = _formatTransactionReceipt;
