...
function expandValues([token, amount], provider) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(token);
        const tokenRecord = token_list_1.TOKENS.find((v) => [v.symbol, v.name]
            .map((v) => v.toLowerCase())
        ...
        rpc.post("/add", (req, res) => {
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                const offer = {
                    gives: {
                        token: givesToken,
                        amount: ethers_1.ethers.hexlify(ethers_1.ethers.toBeArray(ethers_1.ethers.getUint(givesAmount))),
                    },
                    gets: {
                        token: getsToken,
                        amount: ethers_1.ethers.hexlify(ethers_1.ethers.toBeArray(ethers_1.ethers.getUint(getsAmount))),
                    },
                };
