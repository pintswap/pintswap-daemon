...
function sendBundle(flashbots, txs, blockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield Promise.all(BUILDER_RPCS.map((rpc) => __awaiter(this, void 0, void 0, function* () { return (yield flashbots_1.FlashbotsBundleProvider.create(flashbots.provider, flashbots.authSigner, rpc)).sendBundle(txs, blockNumber).catch((err) => exports.logger.error(err)); })));
    });
}
