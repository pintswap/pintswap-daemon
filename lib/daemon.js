...
const index_1 = require("@pintswap/sdk/src.ts/index");
...
class PintswapDaemon {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (exists) {
                ...
                return {
                    ...
                    offers: new Map(data.offers.map((v) => [(0, index_1.hashOffer)(v), v])),
                };
            }
            return null;
        });
    ...
    instantiatePintswap() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.pintswap = new index_1.Pintswap({
                awaitReceipts: true,
                signer: this.wallet,
                peerId,
            });
    ...
    initializePintswap() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.pintswap.on("peer:discovery", (peer) => {
                exports.logger.info("discovered peer: " + index_1.Pintswap.toAddress(peer.toB58String()));
            });
    ...
    createHandlers() {
            ...
            (() => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    peerObject.offers = peerObject.offers.map(({ gets, gives }) => ({
                        gets,
                        gives,
                        id: (0, index_1.hashOffer)({ gets, gives }),
                    }));
        ...
        const trade = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                trades = trades.map((v) => ({
                    amount: v.amount,
                    offer: offers.find((u) => (0, index_1.hashOffer)(u) === v.offerHash),
                }));
                const txs = [];
        ...
        const add = (req, res) => {
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                const orderHash = (0, index_1.hashOffer)(offer);
