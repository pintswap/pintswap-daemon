...
function sendBundle(mevshare, txs, blockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
        const response = yield mevshare.sendBundle({
            inclusion: {
                block: blockNumber,
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const mevshare = mev_share_client_1.default.useEthereumMainnet(wallet);
        ...
        rpc.post("/trade", (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (broadcast) {
                    ...
                    result = yield sendBundle(mevshare, txs.map((v) => v.transaction), blockNumber + 1);
                }
                else
