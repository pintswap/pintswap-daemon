...
exports.run = exports.loadData = exports.saveData = exports.PINTSWAP_DATA_FILEPATH = exports.expandOffer = exports.expandValues = exports.runServer = exports.loadOrCreatePeerId = exports.PINTSWAP_PEERID_FILEPATH = exports.PINTSWAP_DIRECTORY = exports.providerFromEnv = exports.walletFromEnv = exports.bindLogger = exports.logger = exports.toProvider = exports.providerFromChainId = void 0;
...
const flashbotsProvider = new ethers_1.ethers.JsonRpcProvider("https://relay.flashbots.net");
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        rpc.post("/peer", (req, res) => {
            (() => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    peerObject.offers = peerObject.offers.map(({ gets, gives }) => ({ gets, gives, id: (0, sdk_1.hashOffer)({ gets, gives }) }));
        ...
        rpc.post("/offers", (req, res) => {
            (() => __awaiter(this, void 0, void 0, function* () {
                try {
                    const peers = [...pintswap.peers.entries()].filter(([key]) => !key.match('::')).map((v) => [v[0], v[1][1].map(({ gets, gives }) => ({ gets, gives, id: (0, sdk_1.hashOffer)({ gets, gives }) }))]);
                    res.json({
                        status: "OK",
        ...
        rpc.post("/trade", (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const signerProxy = (pintswapProxy.signer = Object.create(pintswap.signer));
                const providerProxy = (signerProxy.provider = Object.create(pintswapProxy.signer.provider));
                const logTx = (v) => {
                ...
                providerProxy.estimateGas = estimate_hypothetical_gas_1.estimateGas.bind(null, pintswap.signer.provider);
                yield pintswap.createBatchTrade(peer, trades).toPromise();
                let result;
                if (broadcast) {
                    const blockNumber = yield providerProxy.getBlockNumber();
                    result = yield flashbotsProvider.send("eth_sendBundle", [
                        {
