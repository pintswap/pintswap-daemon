...
let id = 0;
function sendBundle(txs, targetBlock) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        rpc.post("/trade", (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                providerProxy.estimateGas = (txParams) => __awaiter(this, void 0, void 0, function* () {
                    if (!txParams.to)
                        return yield (0, estimate_hypothetical_gas_1.estimateGas)(pintswap.signer.provider, txParams);
                    return yield estimateGasOriginal.call(pintswap.signer.provider, txParams);
                });
                ...
                if (broadcast) {
                    ...
                    result = yield sendBundle(txs.map((v) => v.transaction), blockNumber + 1);
                }
                else
