...
function sendBundle(signer, txs, blockNumber) {
    return __awaiter(this, void 0, void 0, function* () {
        const body = JSON.stringify({
            id: id++,
            jsonrpc: "2.0",
            method: "eth_sendBundle",
            params: [{ txs, blockNumber: ethers_1.ethers.toBeHex(blockNumber) }]
        }, null, 2);
        console.log('body', body);
        const response = yield (yield fetch("https://relay.flashbots.net", {
            method: "POST",
            body,
            headers: {
                'Content-Type': 'application/json',
                'X-Flashbots-Signature': yield signBundle(signer, body)
            }
        })).text();
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        rpc.post("/trade", (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                providerProxy.waitForTransaction = () => __awaiter(this, void 0, void 0, function* () { return {}; });
                ...
                yield pintswapProxy.createBatchTrade(peer_id_1.default.createFromB58String(peer), trades).toPromise();
                let result;
                if (broadcast) {
                    const blockNumber = yield providerProxy.getBlockNumber();
                    result = yield sendBundle(pintswap.signer, txs.map((v) => v.transaction), blockNumber + 1);
                }
                else
